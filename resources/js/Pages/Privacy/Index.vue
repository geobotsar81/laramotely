        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    <h1 class="centered underlined">Privacy Policy</h1>
                </div>
            </div>
            ...
            <div class="row mt-5">
                <div class="col-12 col-lg-8 offset-lg-2">
                    <p class="py-2">
                        At Laramotely, accessible from www.laramotely.com, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is
                        collected and recorded by Laramotely and how we use it.
                    </p>
                    ...
                    <p class="py-2">
                        ...
                        Laramotely. This policy is not applicable to any information collected offline or via channels other than this website.
                    </p>
                    ...
                    <p class="py-2">
                        Laramotely follows a standard procedure of using log files. These files log visitors when they visit websites. All hosting companies do this and a part of hosting services'
                    ...
                    <p class="py-2">
                        Like any other website, Laramotely uses 'cookies'. These cookies are used to store information including visitors' preferences, and the pages on the website that the visitor
                    ...
                    <p class="py-2">You may consult this list to find the Privacy Policy for each of the advertising partners of Laramotely.</p>
                    ...
                    <p class="py-2">
                        ...
                        Laramotely, which are sent directly to users' browser. They automatically receive your IP address when this occurs. These technologies are used to measure the effectiveness of
                        their advertising campaigns and/or to personalize the advertising content that you see on websites that you visit.
                    </p>

                    <p class="py-2">Note that Laramotely has no access to or control over these cookies that are used by third-party advertisers.</p>

                    <h3>Third Party Privacy Policies</h3>

                    <p class="py-2">
                        Laramotely's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the respective Privacy Policies of these third-party ad
                    ...
                    <p class="py-2">
                        Laramotely does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think that your child provided this kind of information on
